...
namespace Tools.HitsoundCopier
{
    ...
    public class HitsoundCopier
    {
        ...
        public static void CopyFromBeatmap(string sourcePath, string targetPath)
        {
            ...
            var targetComparisonTimingPoints = target.TimingPoints?.TimingPointList.ToList();
            ...
            Console.WriteLine($"Got {hitSoundTimeLine.SoundEvents.Count} hitsounds and {sliderBodyTimeline.SoundEvents.Count} slider body sounds.");
            ...
            // create a degub hitobject section with only circles
