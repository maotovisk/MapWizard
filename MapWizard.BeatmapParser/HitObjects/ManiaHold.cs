...
public class ManiaHold : HitObject
{
    ...
    public ManiaHold(Vector2 coordinates, TimeSpan time, HitObjectType type, (HitSample, List<HitSound>) hitSounds, bool newCombo, uint comboOffset) : base(coordinates, time, type, hitSounds, newCombo, comboOffset)
    { }
